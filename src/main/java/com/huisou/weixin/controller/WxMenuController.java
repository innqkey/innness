...
public class WxMenuController implements WxMpMenuService {
  ...
  public String menuCreateSample() throws WxErrorException {
    ...
    button1.setName("课程安排");
    button1.setUrl("http://sxy.huisou.cn/sxyback/html/index.html?navIndex=0");
    
    WxMenuButton button2 = new WxMenuButton();
    button2.setType(MenuButtonType.VIEW);
    button2.setName("学员中心");
    button2.setUrl("http://sxy.huisou.cn/sxyback/html/index.html?navIndex=0");
